...
<head>
  ...
  <!-- Site Properties -->
  <title>NSU ACM | Delete Gallery</title>
...
<body>
  ...
  <div class="ui main text container">
    ...
    <div class="ui breadcrumb">
      ...
      <div class="active section"><?php echo $row['title']; ?></div>
    </div>
    <div class="ui section divider"></div>
    <form action="" method="post" enctype="multipart/form-data">
      <div class="ui form">
        <div class="field">
          <p>Are you sure you want to delete <?php echo $row['title']; ?> from Gallery?</p>
          <input type="hidden" name="confirm" value="true" />
        </div>
        <input type="submit" class="ui small black button" value="Yes" />
        <a href="gallery.php" class="ui small red button">No</a>
      </div>
    </form>
  </div>
  <!-- footer -->
